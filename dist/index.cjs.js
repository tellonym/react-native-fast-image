...
function FastImageBase({
  ...
  if (fallback) {
    ...
    style && style.borderRadius ? {
      ...
      /* @ts-ignore */
      reactNative.PixelRatio.getPixelSizeForLayoutSize(style.borderRadius))
    } : {};
    const resolvedSource = reactNative.Image.resolveAssetSource(source instanceof Object ? Object.assign({}, cleanedSource, borderRadiusObject) : source);
