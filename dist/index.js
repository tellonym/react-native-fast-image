...
import { NativeModules, StyleSheet, requireNativeComponent, PixelRatio, Image, View } from 'react-native';
...
function FastImageBase({
  ...
  if (fallback) {
    ...
    const resolvedSource = Image.resolveAssetSource(source instanceof Object ? Object.assign({}, cleanedSource, borderRadiusObject) : source);
